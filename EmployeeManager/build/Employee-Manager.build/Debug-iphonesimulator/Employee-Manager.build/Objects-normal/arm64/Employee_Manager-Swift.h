...
#ifndef EMPLOYEE_MANAGER_SWIFT_H
#define EMPLOYEE_MANAGER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Employee_Manager",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC16Employee_Manager11AppDelegate")
...
SWIFT_CLASS("_TtC16Employee_Manager13SceneDelegate")
...
SWIFT_CLASS("_TtC16Employee_Manager14ViewController")
@interface ViewController : UIViewController
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified salaryLabel;
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified salaryTextField;
- (void)viewDidLoad;
- (IBAction)employeeButtonPressed:(UIButton * _Nonnull)sender;
- (IBAction)managerButtonPressed:(UIButton * _Nonnull)sender;
