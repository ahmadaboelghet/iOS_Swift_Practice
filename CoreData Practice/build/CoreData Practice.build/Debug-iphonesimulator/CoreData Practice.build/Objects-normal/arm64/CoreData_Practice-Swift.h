...
#ifndef COREDATA_PRACTICE_SWIFT_H
#define COREDATA_PRACTICE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CoreData_Practice",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC17CoreData_Practice11AppDelegate")
...
SWIFT_CLASS("_TtC17CoreData_Practice13SceneDelegate")
...
@interface User (SWIFT_EXTENSION(CoreData_Practice))
@property (nonatomic) int16_t age;
@property (nonatomic, strong) NSObject * _Nullable password;
...
SWIFT_CLASS("_TtC17CoreData_Practice14ViewController")
